...
- [TimeZoneDB](https://timezonedb.com/) for timezone strings
...
1. Open-source your entire application, OR
2. Purchase a commercial Swiss Ephemeris license from Astrodienst, OR
3. Use the Swiss Ephemeris directly (free for non-commercial)
